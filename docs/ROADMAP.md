...
- Exact unit-aware quantities. ([initial sourced catalogue-property record slice complete](CATALOG_QUANTITY_PROPERTIES.md); unsupported identifiers fail closed; typed property schemas and filtering pending)
