...
- Exact unit-aware quantities. ([sourced catalogue-property records and exact numeric filtering complete](CATALOG_QUANTITY_PROPERTIES.md); initial typed property-schema gate complete for the implemented property set; schema expansion pending)
